...
# Set S to WORKDIR so the install task knows where to find the files
S = "${WORKDIR}"
...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/app.py ${D}/home/root/webui/
    install -m 0644 ${WORKDIR}/templates/index.html ${D}/home/root/webui/templates/
